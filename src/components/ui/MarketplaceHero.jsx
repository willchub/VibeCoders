        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-12 lg:gap-8 items-start">
          ...
          <div className="lg:col-span-5 space-y-6 lg:mt-12">
              ...
              <div className="relative z-10">
                <div className="flex items-center gap-4 mb-8">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-zinc-400">Off Last-Minute</div>
                  </div>
                </div>
                <div className="space-y-3 mb-8">
                  <div className="flex justify-between text-sm">
                    <span className="text-zinc-400">Booked Today</span>
            ...
            <div className="animate-fade-in delay-500 relative overflow-hidden rounded-3xl border border-white/10 bg-white/5 py-8 backdrop-blur-xl">
              <h3 className="mb-6 px-8 text-sm font-medium text-zinc-400">Trusted by local salons & studios</h3>
              <div
                  ...
                  {[...PARTNERS, ...PARTNERS, ...PARTNERS].map((partner, i) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <span className="text-lg font-bold text-white tracking-tight">{partner.name}</span>
                      </div>
                    );
                  })}
                </div>
